...
pub async fn create<'e, E>(executor: E, user: &UserRow) -> db::Result<()>
where
    E: SqliteExecutor<'e>,
{
    sqlx::query(
...
pub async fn get_by_id<'e, E>(executor: E, id: &Uuid) -> db::Result<UserRow>
where
    E: SqliteExecutor<'e>,
{
    Ok(sqlx::query_as(
...
pub async fn get_by_username<'e, E>(executor: E, username: &str) -> db::Result<UserRow>
where
    E: SqliteExecutor<'e>,
{
    Ok(sqlx::query_as(
